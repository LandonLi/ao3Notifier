...
class AO3Api:
    ...
    def __init__(self, base_url: str = None, view_adult: bool = False):
        if base_url:
        ...
        headers = {"User-Agent": os.getenv("User-Agent", "AO3Notifier")}  # TODO 应用名称可配置
    ...
    def get_chapter(self, work_id: str, chapter_id: str) -> typing.Optional[str]:
        logger.debug(
            f"Fetching chapter by work_id: {work_id} and chapter_id: {chapter_id}"
        )
